...
<div class="container mx-auto py-8 p-4">
  ...
  <div class="flex max-w-screen-xl mx-auto w-full justify-between max-md:flex-col max-md:gap-y-5">
    ...
    <div class="flex flex-col border border-[2px] max-w-[540px] w-full p-4 bg-gray-200 rounded-xl gap-y-5 h-fit">
