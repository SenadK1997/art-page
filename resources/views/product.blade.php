...
<section class="flex mx-auto max-w-screen-xl w-full h-[90vh] gap-x-9 max-md:flex-col max-md:gap-y-2 max-md:justify-center max-md:pt-[90px] max-md:overflow-y-scroll max-md:items-center max-md:h-[90vh]">
    <div class="flex flex-col justify-center max-w-screen-xl items-center w-1/2 gap-y-3 mt-12">
    ...
    <div class="flex flex-col gap-y-4 justify-center max-w-[50%] max-md:w-1/2 max-md:max-w-full whitespace-normal break-words">
        <div class="max-md:flex max-md:justify-center">
            <a href="/shop" class="flex px-2 rounded-lg justify-center items-center ease-in duration-300 min-w-[120px] max-w-[150px] py-2 text-center border-solid border-2 border-stone-900 text-white bg-stone-900 hover:text-stone-900 hover:bg-white gap-x-3 lg:hidden">
                ...
                <div class="relative">
                    <select id="color-selector" name="color-selector" class="block appearance-none w-full bg-gray-100 border border-gray-200 text-gray-700 py-2 px-3 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                        {{-- @foreach ($product->images as $item) --}}
                            <option value="border-y-[#ddd] border-x-[#eee]">Siva</option>
                            <option value="border-y-yellow-500 border-x-yellow-400">Zlatna</option>
                            <option value="border-y-pink-500 border-x-pink-400">Roza</option>
                            <option value="border-y-gray-700 border-x-gray-600">Crna</option>
                        {{-- @endforeach --}}
                    </select>
