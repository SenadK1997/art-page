    ...
    <div class="flex max-w-screen-xl mx-auto items-center w-full m-10 justify-between max-md:flex-col max-md:gap-y-4">
        <form class="flex w-full max-w-screen-xl pt-[10px]" type="get" action="{{ url('/shop') }}">
            <div class="flex w-full max-w-screen-xl justify-between items-center gap-x-5 max-md:flex-col max-md:gap-y-3">
                ...
                <button type="submit" class="max-md:hidden text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Trazi</button>
            </div>    
        </form>
            ...
            <a href="/product/{{$item->id}}" class="flex flex-col border-stone-900 border-solid border-4">
                <div class="relative flex flex-col bg-white h-80 w-52">
                    <div class="flex justify-center mx-auto items-center h-full">
                        <img src="{{'storage/thumbnail/' . $item->url}}" alt="" class="w-full h-full object-cover p-2">
                    </div>
                </div>
            </a>
