...
<div class="left-[262px] relative overflow-x-auto sm:rounded-lg p-7 w-full flex flex-col table__width">
    <div class="flex justify-center">
        <div class="relative flex justify-between w-full p-1 pb-5">
            <h1 class="text-2xl font-medium text-stone-700 dark:text-white">LISTA DIMENZIJA<h1>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 mx-auto relative border">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 justify-between w-full max-w-screen-xl">
            <tr>
                ...
                <th scope="col" class="px-6 py-3">Boja okvira</th>
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                ...
                <td scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $img->color }}</td>
                <td class="px-6 py-4">
